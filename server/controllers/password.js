...
exports.forgotPassword = async (req, res, next) => {
    ...
    try {
        ...
        const email = await tranEmailApi.sendTransacEmail({
            ...
            htmlContent: `<h1>Reset your password for Daily Expense Tracker</h1><p>Click the link to reset password</p><a href="http://localhost:3000/password/reset-password/${data.id}">Link</a>`
        })
        console.log(email);
